	...
	return {
		...
		perfectPair:{
            ...
            translate:{
                  ...
                  guihang_info:'出牌阶段，你可以消耗1点灵力，然后将一张牌当作【轰！】使用；该【轰！】不计次数且无视距离；以此法造成弹幕伤害后，弃置受伤角色一张牌，令你与其距离视为1，且此技能无效，直到回合结束。',
                  wujian:'无间之狭间',
                  wujian_skill:'无间之狭间',
                  ...
                  shenpan:'最终审判',
                  shenpan_info:'符卡技（X）<限定>（X为体力值）符卡发动时，你视为使用一张【令避之间】；结束阶段，你对场上体力最高的角色造成１点弹幕伤害，然后对灵力，手牌数，和击坠角色数重复此流程。',
