...
package:{
    ...
    intro:
    '<p style="color:rgb(240,240,200); font-size:12px; line-height:14px; text-shadow: 0 0 1px black;">' +
    '有bug请联系作者，目前拼点牌，置顶牌弃置后的牌，这些有虾皮' + '<br>' +
	'1.9.98.1.11：' + '<br>' +
	'- 新增可变关闭的击杀特效、死亡特效，边框可以自由选择等阶；<br>' +
	'- 血条框现在根据血量上限自动变化；<br>' +
	'- 无限血量现在正常显示为 ∞ / ∞；<br>' +
	'- 卡牌美化素材增加：国战、衍生；<br>' +
	'- 修正只明置单将的情况下显示错误；<br>' +
