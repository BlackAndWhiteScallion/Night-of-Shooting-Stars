	                    	 ...
	                    	 if (!lib.config.akyuu){
		                    	...
		                    	p.onclick = function(){
		                    		...
		                    		var h = [['其实流星夜有个四格漫画系列，<br>可以在贴吧和群里找到哟。',
		                    				...
		                    				['幻想乡是个很神奇的地方。<br>撰写《幻想乡缘起》的初衷<br>是教导人类们对付妖怪<br>现在看来，<br>记载丰富多彩的大家也不错呢。',
		                    				...
		                    				'因为符卡规则，<br>妖怪不但不惧怕，<br>甚至还相当欢迎与巫女的正面冲突。<br>也造成了异变事件常常发生。<br>随着时间的推移，<br>异变对人类的影响也越来越少。<br>而本来可怕的妖怪，<br>对人类的友好度也高了起来……',
		                    				'即使是幻想乡，<br>先吃饱才能表演的规则也是没变。<br>所以，不用介意生计的妖怪们<br>用异变进行表演，<br>而异变则招来更多的妖怪…<br>算是良性循环吧？',
		                    				'是不是好事，我也说不上来。<br>总之，我工作量是大幅度增加了呢……<br>啊，不说了，我还要赶死线呢！'],
		                    				];
									var k = h[f][counter];
